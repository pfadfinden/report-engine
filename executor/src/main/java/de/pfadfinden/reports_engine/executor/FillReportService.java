...
public class FillReportService {
    public void fill(ReportDefinition reportDefinition, Map<String, Object> parameter, Connection conn,
            OutputStream output, OutputFormat format) throws FailedToFillReport, FailedToExportReport {
        JasperPrint filledReport;
        try {
            filledReport = JasperFillManager.getInstance(reportDefinition.jasperReportsContext)
