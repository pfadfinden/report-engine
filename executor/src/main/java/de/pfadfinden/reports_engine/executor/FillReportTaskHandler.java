...
public class FillReportTaskHandler {
    ...
    public FillReportTaskHandler(Connection conn, ReportLoader reportLoader, ReportOutputStore reportOutputStore) {
    ...
    public void execute(ReportTaskConfiguration task) throws FailedToLoadReport, FailedToFillReport, FailedToExportReport, FailedToStoreReport {
            ...
            this.fillReportService.fill(reportDefinition, task.parameters, this.conn, output, task.outputFormat);
    }
}
