...
/**
 * GET /executions/{executionId}/download - part of the shared trigger/
 * status/download API contract. Always returns { "url": ... }, a SAS-signed
 * blob URL, never the bytes and never a redirect - matches
 * local-report-executor's equivalent endpoint exactly.
 */
public class DownloadExecutionResultFunction {
    ...
    public HttpResponseMessage run(
        ...
        String url = new BlobReportOutputStore(storageConnectionString).generateDownloadUrl(executionId, extension);
