...
/**
 * {@link IVersionProvider} implementation that returns version information from the *.jar file's
...
class ManifestVersionProvider implements IVersionProvider {
  ...
  private boolean isApplicableManifest(Manifest manifest) {
    ...
    return "reports-engine-preprocessor".equals(get(attributes, "Implementation-Title"));
  }
