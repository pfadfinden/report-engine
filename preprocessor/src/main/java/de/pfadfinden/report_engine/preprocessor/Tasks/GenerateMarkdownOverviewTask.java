...
public class GenerateMarkdownOverviewTask extends AbstractFollowUpTaskCommand {
  ...
  @Option(
      names = {"--fileName"},
      defaultValue = "overview.md",
      description = "store the output in this file, including suffix.")
  ...
  public void export(Stream<ReportMetadata> reports) {
    ...
    try (Writer writer =
      ...
      writer
          ...
          .append("\n\n")
          .append(new Text("Auto-generated overview of reports:").toString())
          .append("\n")
          .append(reportsTable.build().toString())
          .append("\n");
