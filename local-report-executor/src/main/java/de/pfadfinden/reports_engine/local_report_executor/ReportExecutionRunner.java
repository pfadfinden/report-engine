...
/**
 * Runs a triggered report fill in the background and updates the ExecutionStore with the outcome.
 * Loads the report once (to both fill it and inspect its declared parameter types for coercion),
 * rather than going through FillReportTaskHandler, which would load it a second time internally.
 */
